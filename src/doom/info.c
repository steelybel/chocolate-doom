...
state_t	states[NUMSTATES] = {
    ...
    {SPR_PUNG,5,1,{A_Lower},S_PUNCHDOWN,0,0},	// S_PUNCHDOWN
    ...
    {SPR_PISG,0,1,{NULL},S_PISTOL2,0,32},	// S_PISTOL1
    ...
    {SPR_SHTG,32769,2,{A_FireShotgun},S_SGUN3,0,0},	// S_SGUN2
    {SPR_SHTG,7,4,{NULL},S_SGUN4,0,0},	// S_SGUN3
    {SPR_SHTG,0,3,{NULL},S_SGUN5,0,0},	// S_SGUN4
    {SPR_SHTG,3,5,{NULL},S_SGUN6,0,0},	// S_SGUN5
    {SPR_SHTG,4,2,{NULL},S_SGUN7,0,0},	// S_SGUN6
    ...
    {SPR_PISG,0,1,{NULL},S_DSNR2,0,32},	// S_DSNR1
    {SPR_PISG,0,3,{A_ReFire},S_PISTOL,0,32},	// S_DSNR2
    {SPR_CHGF,32770,2,{A_Light2},S_LIGHTDONE,0,0},	// S_DSGUNFLASH1
    {SPR_PISF,32768,2,{A_Light1},S_LIGHTDONE,0,0},	// S_DSGUNFLASH2
    ...
    {SPR_CHGF,32768,2,{A_FireCGun},S_CHAIN2,0,32},	// S_CHAIN1
    {SPR_CHGF,1,1,{NULL},S_CHAIN3,0,32},	// S_CHAIN2
    {SPR_CHGF,32768,2,{A_FireCGun},S_CHAINFLASH1,1,31},	// S_CHAIN3
    {SPR_CHGG,1,2,{NULL},S_CHAINFLASH2,0,32},	// S_CHAINFLASH1
    {SPR_CHGG,0,5,{A_ReFire},S_CHAIN,0,32},	// S_CHAINFLASH2
    ...
    {SPR_MISF,32769,6,{A_OpenShotgun2},S_MISSILEFLASH3,0,0},	// S_MISSILEFLASH2
    ...
    {SPR_MISL,32769,2,{NULL},S_EXPLODE2,0,0},	// S_EXPLODE1
    {SPR_MISL,32770,6,{A_Explode},S_EXPLODE3,0,0},	// S_EXPLODE2
    {SPR_MISL,32771,8,{NULL},S_NULL,0,0},	// S_EXPLODE3
    ...
    {SPR_SKEL,3,2,{A_Chase},S_SKEL_RUN1,0,0},	// S_SKEL_RUN8
    ...
    {SPR_SKEL,7,0,{A_FaceTarget},S_SKEL_FIST2,0,0},	// S_SKEL_FIST1
    {SPR_SKEL,7,6,{A_SkelWhoosh},S_SKEL_FIST3,0,0},	// S_SKEL_FIST2
    {SPR_SKEL,8,6,{A_FaceTarget},S_SKEL_FIST4,0,0},	// S_SKEL_FIST3
    {SPR_SKEL,9,6,{A_SkelFist},S_SKEL_RUN1,0,0},	// S_SKEL_FIST4
    {SPR_SKEL,4,0,{A_FaceTarget},S_SKEL_MISS2,0,0},	// S_SKEL_MISS1
    {SPR_SKEL,4,10,{A_FaceTarget},S_SKEL_MISS3,0,0},	// S_SKEL_MISS2
    {SPR_SKEL,32773,10,{A_SkelMissile},S_SKEL_MISS4,0,0},	// S_SKEL_MISS3
    {SPR_SKEL,6,10,{A_FaceTarget},S_SKEL_RUN1,0,0},	// S_SKEL_MISS4
    {SPR_SKEL,10,5,{NULL},S_SKEL_PAIN2,0,0},	// S_SKEL_PAIN
    {SPR_SKEL,10,5,{A_Pain},S_SKEL_RUN1,0,0},	// S_SKEL_PAIN2
    ...
    {SPR_SKUL,32768,10,{A_FaceTarget},S_SKULL_ATK2,0,0},	// S_SKULL_ATK1
    {SPR_SKUL,32770,4,{A_BspiAttack},S_SKULL_ATK3,0,0},	// S_SKULL_ATK2
    {SPR_SKUL,32771,4,{A_BspiAttack},S_SKULL_ATK4,0,0},	// S_SKULL_ATK3
    {SPR_SKUL,32768,1,{A_CPosRefire},S_SKULL_ATK2,0,0},	// S_SKULL_ATK4
    {SPR_SKUL,32772,3,{NULL},S_SKULL_PAIN2,0,0},	// S_SKULL_PAIN
    {SPR_SKUL,32772,3,{A_Pain},S_SKULL_RUN1,0,0},	// S_SKULL_PAIN2
    {SPR_SKUL,32773,6,{A_Scream},S_SKULL_DIE2,0,0},	// S_SKULL_DIE1
    {SPR_SKUL,32774,6,{A_Fall},S_SKULL_DIE3,0,0},	// S_SKULL_DIE2
    {SPR_SKUL,32775,6,{NULL},S_SKULL_DIE4,0,0},	// S_SKULL_DIE3
    {SPR_BEXP,32769,6,{NULL},S_SKULL_DIE5,0,0},	// S_SKULL_DIE4
    {SPR_BEXP,32771,6,{NULL},S_SKULL_DIE6,0,0},	// S_SKULL_DIE5
    {SPR_BEXP,32772,6,{NULL},S_NULL,0,0},	// S_SKULL_DIE6
    ...
    {SPR_APBX,32768,3,{NULL},S_ARACH_PLEX2,0,0},	// S_ARACH_PLEX
    ...
    {SPR_BAR1,0,6,{NULL},S_BAR1,0,0},	// S_BAR1
    {SPR_BAR1,32771,6,{NULL},S_BEXP,0,0},	// S_BAR2
    {SPR_BEXP,32768,5,{A_Scream},S_BEXP2,0,0},	// S_BEXP
    {SPR_BEXP,32769,4,{A_Explode},S_BEXP3,0,0},	// S_BEXP2
    {SPR_BEXP,32770,4,{NULL},S_BEXP4,0,0},	// S_BEXP3
    {SPR_BEXP,32771,4,{NULL},S_BEXP5,0,0},	// S_BEXP4
    {SPR_BEXP,32772,4,{NULL},S_NULL,0,0},	// S_BEXP5
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
	...
	3,		// damage
	sfx_None,		// activesound
	MF_SOLID|MF_SHOOTABLE|MF_FLOAT|MF_NOGRAVITY|MF_NOBLOOD,		// flags
	S_NULL		// raisestate
    },
