...
{
    {1,"M_JKILL",	M_ChooseSkill, '1'},//orig: i
    {1,"M_ROUGH",	M_ChooseSkill, '2'},//orig: h
    {1,"M_HURT",	M_ChooseSkill, '3'},//orig: h, again
    {1,"M_ULTRA",	M_ChooseSkill, '4'},//orig: u
    {1,"M_NMARE",	M_ChooseSkill, '5'} //orig: n
};
